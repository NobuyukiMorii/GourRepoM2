...
<div class="col-xs-12 center-button">
    <span id="signinButton" class="pre-sign-in">
      <div style="margin-top:48%;">Googleアカウントにログインしてください。</div>
      <br>
      <span
          class="g-signin"
    ...
    <?php echo $this->Form->create('Movie', array('type' => 'post' , 'action' => 'edit' ,'id' => 'upload-form')); ?>
      ...
      <div>
        ...
        <!-- textarea -->
          ...
          <div class="col-xs-12 margin" style="margin-top:14%;">
            <button type="submit" class="btn btn-default btn-lg btn-block" id="submit">アップロード</button>
          </div>
